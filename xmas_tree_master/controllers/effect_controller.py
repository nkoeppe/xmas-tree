...
class EffectController:
    ...
    def change_effect(self, effect_name, **kwargs):
        ...
        effect = effect_class(pixels=self.controller.pixels, coords=self.controller.coords, min_y=self.controller.min_y, max_y=self.controller.max_y,min_x=self.controller.min_x, max_x=self.controller.max_x,min_z=self.controller.min_z, max_z=self.controller.max_z, center=self.controller.three_d_center,  **kwargs)
